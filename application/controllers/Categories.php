...
class Categories extends CI_Controller {
	...
	public function showmodal()
	{
		...
		$htmlWrapper .= 	"<input type='text' name='nom_categorie' id='nom_categorie' class='form-control input-sm' placeholder='Libellé' value='".$nom_categorie."'>" ;
		$htmlWrapper .= "</div>" ;
		$htmlWrapper .= "<div class='form-group'>" ;
		$htmlWrapper .= 	"<label for='commentaire_categorie'>Descriptions</label>" ;
		$htmlWrapper .= 	"<textarea name='commentaire_categorie' id='commentaire_categorie' class='form-control input-sm'>".$commentaire_categorie."</textarea>" ;
		$htmlWrapper .= "</div>" ;
		$htmlWrapper .= "<div class='form-group'>" ;
