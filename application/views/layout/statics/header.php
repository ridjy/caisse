	...
	<ul class="nav-notification clearfix">
		<li class="profile dropdown">
			...
			<ul class="dropdown-menu">
				...
				<li class="divider"></li>
				<li>
					<?php /* ?><a tabindex="-1" class="main-link logoutConfirm_open" href="#logoutConfirm"><?php */ ?>
					<a class="main-link" href="<?php echo BASE_URL ?>/options">
						<i class="fa fa-cog fa-lg"></i>&nbsp;Configuration du site
					</a>
					<?php
						$session = $this->session->userdata('logged_in');
						$role = $session['role'] ;
