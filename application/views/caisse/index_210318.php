	    ...
	    <div class="modal-dialog modal-lg">
	        <div class="modal-content">
	            ...
	            <div class="modal-body">
	            	<div class="row">
								...
								<div class="panel-body"  style="overflow: auto;height: 200px;">
									...
									?>
										<div class="col-lg-6" style="margin-top:4px">
											...
											<button class="btn btn-lg btn-default btn-block" onclick="Afficher_RR(this)" data-rr="<?php echo $data->RR ?>" data-prefixe="<?php echo $data->prefixe ?>" data-id_mp="<?php echo $data->id_mp ?>"><?= $data->type; ?></button>
										</div>	
									<?php
										}
									?>
						...
						<div style="height: 175px" id="TypeMP">
							...
							<div class="col-lg-6" id="Content_RenduMP" style="display: none">
								<div class="form-group">
									<label for="RenduMP">RECU</label>
									<div class="input-group">
										<input class="form-control" id="RecuMP" type="text">
										<span class="input-group-addon"><i class="fa fa-check"></i></span>
									</div>
								</div>
							...
							<div class="col-lg-6" id="Content_ReferenceMP" style="display: none">
								<div class="form-group">
	            		...
	            		<div class="col-lg-6">
	            			<div class="row">
	            				<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="7">7</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="8">8</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="9">9</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="4">4</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="5">5</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="6">6</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="1">1</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="2">2</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="3">3</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" value="0">0</button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" onclick="retour_MP()"><i class="fa fa-arrow-left"></i></button></div>
								<div class="col-sm-4"><button class="btn btn-info btn-lg btn-block B" onclick="reload_MP()">CE</button></div>
	            			</div>
	            		</div>
	            	</div>
	            </div>
	            <div class="modal-footer">
	                ...
	                <span class="btn btn-success btn-sm" aria-hidden="true" onclick="MP_OK()">OK</span>
	            </div>
...
<script src="<?php echo BASE_URL.'/assets/js/jquery-1.10.2.min.js'; ?>"></script>
	...
	<script>
		...
		function print_caisse() {
			...
			$('#Content_ReferenceMP').hide();
			$('#Content_RenduMP').hide();
			$('#TotalMP').val(a);
			$('#ResteMP').val(a);
			$('#RenduMP').val('');
			$('#RecuMP').val('');
		...
		function MP_OK (argument) {
			...
			$.ajax({
				url: root+'Caisse/Add',
				type: 'POST',					
				data: {"TABARTICLE": tabArticle,"MODEPAIEMENT":idModePaiement},
				dataType:"json" ,
				success : function(d){
		...
		$(document).scannerDetection({
		    ...
		    onError: function () {
		    	alert("Veuillez réessayer ou activer votre MAJ");
		    }
		});	*/
	</script>
